...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="mb-8">
        <a href="/vencimiento/index.php?action=alertas" class="text-blue-600 hover:text-blue-800 font-semibold">
            ← Volver a alertas
        </a>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <form method="POST" action="/vencimiento/index.php?action=configurar_alertas" class="space-y-8">
            ...
            <div class="flex gap-4 pt-6">
                ...
                <a href="/vencimiento/index.php?action=alertas" class="flex-1 bg-gray-300 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-400 transition font-semibold text-center">
                    Cancelar
                </a>
            </div>
        </form>
