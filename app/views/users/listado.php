...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 flex justify-between items-center">
        ...
        <a href="/claude/index.php?action=crear_usuario" class="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-3 rounded-lg hover:shadow-lg transition">
            + Crear Usuario
        </a>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-8">
        <form method="GET" action="/claude/index.php?action=usuarios" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        <?php if (empty($usuarios)): ?>
            <div class="p-6 text-center text-gray-500">
                ...
                <a href="/claude/index.php?action=crear_usuario" class="text-blue-600 hover:text-blue-800 mt-2 inline-block">Crear el primer usuario →</a>
            </div>
        <?php else: ?>
                    ...
                    <tbody>
                        <?php foreach ($usuarios as $user): ?>
                            ...
                            <tr class="border-b hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <a href="/claude/index.php?action=editar_usuario&id=<?php echo $user['id']; ?>" 
