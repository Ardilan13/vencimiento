...
class InventoryController extends BaseController
{
    ...
    private function guardarProducto()
    {
        ...
        if ($stmt->execute()) {
            header('Location: /claude/index.php?action=inventory&mensaje=Producto creado correctamente');
            exit;
        } else {
            return $this->renderizar('inventory/crear_producto', [
    ...
    private function guardarLote()
    {
        ...
        if ($stmt->execute()) {
            ...
            header('Location: /claude/index.php?action=inventory&mensaje=Lote agregado correctamente');
            exit;
        } else {
            return $this->renderizar('inventory/agregar_lote', [
    ...
    public function detallesProducto()
    {
        ...
        if (empty($producto_id)) {
            header('Location: /claude/index.php?action=inventory');
            exit;
        }
